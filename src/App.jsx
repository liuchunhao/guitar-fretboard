  ...
  const scalePatterns = {
    'C Major': {
      ...
      '3NPS - Mixolydian (Root G)': [
        ...
        [3, 5], [3, 7], [3, 9], // D: F, G, A
        [2, 5], [2, 7], [2, 9], // G: B, C, D
        [1, 6], [1, 8], [1, 10], // B: E, F, G
        [0, 8], [0, 10], [0, 12] // High E: C, D, E
      ],
      ...
      '3NPS - Aeolian (Root A)': [
        ...
        [4, 5], [4, 7], [4, 8], // A: D, E, F
        [3, 7], [3, 9], [3, 10], // D: G, A, B
        [2, 7], [2, 9], [2, 10], // G: C, D, E
        [1, 8], [1, 10], [1, 12], // B: F, G, A
        [0, 8], [0, 10], [0, 12]  // High E: C, D, E
      ],
      ...
      '3NPS - Locrian (Root B)': [
        ...
        [3, 9], [3, 10], [3, 12], // D: A, B, C
        [2, 9], [2, 10], [2, 12], // G: D, E, F
        [1, 10], [1, 12], [1, 13], // B: G, A, B
        [0, 10], [0, 12], [0, 13]  // High E: D, E, F
      ]
    },
